...
/**
 * Registers node resize extension.
 * @param {cytoscape} cytoscape Cytoscape library
 * @param {cytoscape.Core} graph Cytoscape Graph instance
 * @returns {nodeResize} nodeResize object
 */
export default function aurNodeResize (cytoscape, graph) {
  ...
  return graph.nodeResize(defaults)
}
